    ...
    <div class="container">
        ...
        <div class="container">
          <div class="row bottomPadding">
            ...
            <a href="https://whatcha-bringing.onrender.com/" target="_blank"><img class="img-responsive center-block imageBorder" src="whatcha-bringing-screen-900.png" alt="event web form"></a>
            </div>
          </div>
          <div class="row bottomPadding">
            <div class="col-md-8 col-md-offset-2">
        ...
        <nav aria-label="" class="bottomPadding">
          <ul class="pager">
            <li><a href="game_hub.php">Next Project <span aria-hidden="true">&rarr;</span></a></li>
          </ul>
        </nav>
    <!-- End Main Content -->
